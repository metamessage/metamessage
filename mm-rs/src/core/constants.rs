...
pub const TAG_CHILD_NULLABLE: u8 = 19 << 3; // 0x98
pub const TAG_CHILD_ALLOW_EMPTY: u8 = 20 << 3; // 0xA0
pub const TAG_CHILD_UNIQUE: u8 = 21 << 3; // 0xA8
pub const TAG_CHILD_DEFAULT_VAL: u8 = 22 << 3; // 0xB0
pub const TAG_CHILD_MIN: u8 = 23 << 3; // 0xB8
pub const TAG_CHILD_MAX: u8 = 24 << 3; // 0xC0
pub const TAG_CHILD_SIZE: u8 = 25 << 3; // 0xC8
pub const TAG_CHILD_ENUMS: u8 = 26 << 3; // 0xD0
pub const TAG_CHILD_PATTERN: u8 = 27 << 3; // 0xD8
pub const TAG_CHILD_LOCATION: u8 = 28 << 3; // 0xE0
pub const TAG_CHILD_VERSION: u8 = 29 << 3; // 0xE8
pub const TAG_CHILD_MIME: u8 = 30 << 3; // 0xF0
pub const TAG_MORE: u8 = 31 << 3; // 0xF8
