...
// go test -v -run TestValueToNode
//
// go test internal/jsonc/*.go -v -run TestValueToNode/empty_slice_int

// go test internal/jsonc/*.go -v -run TestValueToNodeA
...
func TestValueToNode_InvalidInput(t *testing.T) {
...
func TestValueToNodeA(t *testing.T) {
	type A struct {
