...
// go test ./internal/core -v -run TestEncodeObject
//
// go test ./internal/core -v -run TestEncodeObject/t1
//
// go test ./internal/core -test.fullpath=true -benchmem -run=^$ -bench ^BenchmarkEncodeObject_MM$ -benchtime=1000000x
// go test ./internal/core -test.fullpath=true -benchmem -run=^$ -bench ^BenchmarkEncodeObject_JSON$ -benchtime=1000000x
