...
func TestToRustGeneratesCode(t *testing.T) {
	obj := &ir.NodeObject{
		...
		Fields: []*ir.Field{
			{Key: "name", Value: &ir.NodeScalar{Text: "alice", Tag: &ir.Tag{Type: ir.ValueTypeStr}}},
			{Key: "data", Value: &ir.NodeScalar{Text: "abc", Tag: &ir.Tag{Type: ir.ValueTypeBytes}}},
			{Key: "ids", Value: &ir.NodeArray{Tag: &ir.Tag{Type: ir.ValueTypeArr, ChildType: ir.ValueTypeI}, Items: []ir.Node{
				&ir.NodeScalar{Text: "1", Tag: &ir.Tag{Type: ir.ValueTypeI}},
				&ir.NodeScalar{Text: "2", Tag: &ir.Tag{Type: ir.ValueTypeI}},
			}}},
			{Key: "meta", Value: &ir.NodeObject{Tag: &ir.Tag{Name: "meta"}, Fields: []*ir.Field{
				{Key: "count", Value: &ir.NodeScalar{Text: "5", Tag: &ir.Tag{Type: ir.ValueTypeI}}},
			}}},
		},
	}
