...
typedef enum {
  ...
  MMC_VALUE_TYPE_BIGINT,
  MMC_VALUE_TYPE_ARR,
  MMC_VALUE_TYPE_VEC,
  MMC_VALUE_TYPE_OBJ,
  MMC_VALUE_TYPE_MAP,
  MMC_VALUE_TYPE_DATETIME,
  MMC_VALUE_TYPE_DATE,
  MMC_VALUE_TYPE_TIME,
  MMC_VALUE_TYPE_UUID,
  MMC_VALUE_TYPE_DECIMAL,
  MMC_VALUE_TYPE_IP,
  MMC_VALUE_TYPE_URL,
  MMC_VALUE_TYPE_EMAIL,
  MMC_VALUE_TYPE_ENUMS,
  MMC_VALUE_TYPE_MEDIA
} MMC_ValueType;
...
enum MMC_NodeType { MMC_NODE_VALUE, MMC_NODE_OBJECT, MMC_NODE_ARRAY };
